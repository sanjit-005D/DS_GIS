#!/usr/bin/env node
// Simple static preview server (CommonJS) that sets Cache-Control and X-Content-Type-Options headers
// Usage: node scripts/preview-server.cjs [port] (defaults to 5177)
