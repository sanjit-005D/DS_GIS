...
// Use the unsimplified geoBoundaries ADM4 source for higher-fidelity splits
const geoBoundariesPath = path.join(workspaceRoot,'tmp','geoBoundaries','geoBoundaries-IND-ADM4.geojson');
