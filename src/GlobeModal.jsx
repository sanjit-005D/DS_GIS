...
import GroupingAnalysisPopup from './lib/GroupingAnalysisPopup'
...
export default function GlobeModal({ open, onClose, _selectedSNo, selectedTable, selectedIdColumn, spectralRanges, setSpectralRanges, activeRangeIndex, setActiveRangeIndex }) {
  ...
  // State for horizontal color palette module (if enabled)
    ...
    <div className="globe-modal-overlay" onClick={onClose}>
      <div className="globe-modal" onClick={(e) => e.stopPropagation()} style={{ position: 'relative' }}>
        ...
        {/* Compact top-left basemap + samples toggle (restored to old position) */}
          ...
          {ENABLE_LIGHT_MAP_UPGRADES && groupingEnabled && (groupingMethod === 'pca' || groupingMethod === 'clustering' || groupingMethod === 'rf') && (
            <div
              ref={pcaPanelRef}
      ...
      {ENABLE_LIGHT_MAP_UPGRADES && groupingEnabled && groupRepresentation && (
        <GroupingAnalysisPopup
          groupRepresentation={groupRepresentation}
          groupAssignments={groupAssignments}
          groupColors={GROUP_COLORS}
          rect={groupRepPanelRect}
          minimized={groupRepPanelMinimized}
          setMinimized={setGroupRepPanelMinimized}
          onRectChange={setGroupRepPanelRect}
          onPointerDown={onGroupRepPanelPointerDown}
          onResizeStart={startPopupResize}
          textColor={textColor}
          controlBg={controlBg}
        />
      )}
